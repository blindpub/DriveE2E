...
NameMapping = {
    ...
    "vehicle.carlamotors.european_hgv": 'car',
    "vehicle.mercedes.coupe": 'car',
    "vehicle.mercedes.sprinter": 'car',
    "vehicle.mitsubishi.fusorosa": 'car',
    "vehicle.nissan.patrol": 'car',
    "vehicle.seat.leon": 'car',
    "vehicle.toyota.prius": 'car',
    "vehicle.volkswagen.t2": 'car',
    "vehicle.volkswagen.t2_2021": 'car',
    ...
    ## DriveE2E
    "vehicle.yamaha.yzf": 'bicycle',

    ## DriveE2E
    "vehicle.vespa.zx125": 'car',
    ...
    ## DriveE2E
    "walker.pedestrian.0037": 'pedestrian',
    "walker.pedestrian.0039": 'pedestrian',
    ...
    "walker.pedestrian.0023": 'pedestrian',
    "walker.pedestrian.0024": 'pedestrian',
    "walker.pedestrian.0026": 'pedestrian',
    "walker.pedestrian.0027": 'pedestrian',
    "walker.pedestrian.0028": 'pedestrian',
    "walker.pedestrian.0029": 'pedestrian',
    "walker.pedestrian.0030": 'pedestrian',
    "walker.pedestrian.0031": 'pedestrian',
    "walker.pedestrian.0032": 'pedestrian',
    "walker.pedestrian.0033": 'pedestrian',
    "walker.pedestrian.0034": 'pedestrian',
    "walker.pedestrian.0036": 'pedestrian',
    "walker.pedestrian.0038": 'pedestrian',
    "walker.pedestrian.0040": 'pedestrian',
    "walker.pedestrian.0042": 'pedestrian',
    "walker.pedestrian.0043": 'pedestrian',
    "walker.pedestrian.0044": 'pedestrian',
    "walker.pedestrian.0045": 'pedestrian',
    "walker.pedestrian.0048": 'pedestrian',
    "walker.pedestrian.0049": 'pedestrian',
    "walker.pedestrian.0050": 'pedestrian',
...
# # DriveE2E Mini
# data_root = "./data/drivee2e"
# info_root = "./data/drivee2e_infos"
# map_root = "./data/drivee2e/maps"
# map_file = "./data/drivee2e_infos/b2d_map_infos.pkl"

# DriveE2E All: 600
data_root = "Bench2DriveZoo/data/drivee2e"
info_root = "./data/drivee2e_infos_20240929"
map_root = "Bench2DriveZoo/data/drivee2e/maps_new_20240929"
map_file = "./data/drivee2e_infos_20240929/b2d_map_infos.pkl"
...
# load_from="./work_dirs/bevformer_base_b2d/epoch_2.pth"
# resume_from="./adzoo/uniad/work_dirs/stage2_e2e/base_e2e_b2d/epoch_2.pth"
# load_from = "./ckpts/uniad_base_b2d.pth"
load_from = "./adzoo/uniad/work_dirs/stage1_track_map/base_track_map_b2d/epoch_3.pth"
