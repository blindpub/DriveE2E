...
def accumulate(gt_boxes,
    ...
    #     if box.detection_name not in class_nums_gt:
    #         class_nums_gt[box.detection_name] = 0
    #     else:
    #         class_nums_gt[box.detection_name] += 1
                
    # class_nums = {}
    # for box in pred_boxes.all:
    #     if box.detection_name not in class_nums:
    #         class_nums[box.detection_name] = 0
    #     else:
    #         class_nums[box.detection_name] += 1
