...
net = TCP(config)
ckpt = torch.load('log/drivee2e_final_TCP/last-v2.ckpt', map_location="cuda")
...
config.val_data = 'tcp_drivee2e_final-val.npy'
val_set = Drivee2e_Data(root=config.root_dir_all, data_path=config.val_data, img_aug=False)
