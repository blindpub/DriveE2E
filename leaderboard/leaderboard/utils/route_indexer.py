...
class RouteIndexer():
    def __init__(self, scenario_flag,routes_file, repetitions, routes_subset, route2weather_file):
        self._configs_dict = OrderedDict()
        self._configs_list = []
        self.index = 0

        route_configurations = RouteParser.parse_routes_file(scenario_flag,routes_file, routes_subset, route2weather_file)
